...
from app.db.models import RecoveryOpportunity, Payment, AgentDecision, RecoveryAction
...
def get_opportunity(
    ...
    """Fetches opportunity details, linked payment info, and latest decision."""
    ...
    return OpportunityDetail(
        ...
        requires_approval=latest_decision.requires_approval if latest_decision else False,
